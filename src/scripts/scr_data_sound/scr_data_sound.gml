...
function game_sound_play(_asset) {
	...
	var _data = global.data_sound[$ asset_get_index(_asset)];
	if _data != undefined {
...
data_sound_add(nameof(sfx_pop_0), 10, 0.8);
data_sound_add(nameof(sfx_pop_1), 10, 0.8);
data_sound_add(nameof(sfx_pop_2), 8, 0.8);
